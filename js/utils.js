...
globalThis.VERSION_NUMBER = /* 5ETOOLS_VERSION__OPEN */"1.210.51"/* 5ETOOLS_VERSION__CLOSE */;
...
UrlUtil.CAT_TO_PAGE[Parser.CAT_ID_CHARACTER] = UrlUtil.PG_CHARACTERS;
...
if (!globalThis.IS_VTT && typeof window !== "undefined") {
	...
	window.addEventListener("load", () => {
		if (Renderer && Renderer.dice && Renderer.dice.bindOnclickListener) {
			Renderer.dice.bindOnclickListener(document.body);
		}
		if (Renderer && Renderer.events && Renderer.events.bindGeneric) {
